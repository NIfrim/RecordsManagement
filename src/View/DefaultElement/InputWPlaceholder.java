...
public class InputWPlaceholder extends JTextField {

    private String placeholder;

    public InputWPlaceholder()
    {
        this(20);
    }

    public InputWPlaceholder(final int columns) {
        this(columns, "Placeholder");
    }

    public InputWPlaceholder(final int pColumns, final String placeholder) {
        super(pColumns);
